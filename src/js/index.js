...
function render(variables = {}) {
  ...
  if (variables.role == null) variables.role = "Web Developer"; // Display value for Name
  if (variables.city == null) variables.city = "Miami"; // Display value for Name
  if (variables.country == null) variables.country = "USA"; // Display value for Name
